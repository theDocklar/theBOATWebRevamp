...
// schemaUrl is separate from each card's on-page "Learn more" href: two of
// the four services (Shopify + commerce, Creative studio) link visitors to
// /stores and /frames directly, while the other two send visitors to
// #contact — but for schema.org's Service.url, all four resolve to the
// page that actually describes the service, which for the two without a
// dedicated page is the homepage services section.
