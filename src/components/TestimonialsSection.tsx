...
const testimonials = [
  {
    stars: 5,
    quote:
      "Came for a website, stayed for the strategy, left with a complete operational system. Honest, fast, and surgical with feedback.",
    highlight: "left with a complete operational system.",
    name: "Anjali R.",
  ...
  },
  {
    stars: 5,
    quote:
      "They didn't just take the brief — they challenged our assumptions and shipped something sharper than what we asked for. Felt like having a co-founder who codes.",
    highlight: "Felt like having a co-founder who codes.",
    name: "Marco D.",
    role: "COO · Perfomad",
    color: "#6b9cf4",
    dark: true,
  },
  {
    stars: 5,
    quote:
      "They mapped our messy ops into one clean Notion + Shopify pipeline. We've saved roughly 40 hours a month.",
    highlight: "one clean Notion + Shopify pipeline.",
    name: "Saanvi K.",
    role: "CEO · Teragon",
    color: "#6bcf7f",
    dark: false,
